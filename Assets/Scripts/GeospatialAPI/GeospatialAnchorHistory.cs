...
namespace i5.LLM_AR_Tourguide.GeospatialAPI
{
    ...
    /// <summary>
    ///     A serializable struct that stores the basic pointOfInterests of a persistent geospatial anchor.
    /// </summary>
    [Serializable]
    ...
    public class GeospatialAnchorHistoryCollection
    {
        ...
        /// </summary>
        public List<GeospatialAnchorHistory> Collection = new();
    }
}